...
//                var h = f.querySelector(t.barSelector), l = u ? "-100" : r(n.status || 0), e = document.querySelector(t.parent), o;
//                return i(h, {
//                    transition: "all 0 linear",
//                    transform: "translate3d(" + l + "%,0,0)"
//                }),
//                    t.showSpinner || (o = f.querySelector(t.spinnerSelector),
//                        o && c(o)),
...
//                        return t;
//                    for (i = n.length,
//                        f = t.charAt(0).toUpperCase() + t.slice(1); i--;)
//                        if (r = n[i] + f,
//                            r in u)
//                            return r;
//                    return t
...
master.start = function (n) {
    ...
    console.log("follow me  %chttps://www.icqcore.com/", "color:#6bc30d");
    n(".blog-user img").hover(function () {
        var n = layer.tips("点击退出", ".blog-user", {
            tips: [3, "#009688"]
        })
